...
namespace Mechanics.Enemies
{
    public class Slime : Enemy
    {
        ...
        protected override void FixedUpdate()
        {
            ...
            if (!Physics2D.OverlapPoint(Tr.position + new Vector3(_direction.x * 2f, -1, 0), LayerMask.GetMask("Obstacle")) || Physics2D.OverlapCircle(Tr.position + new Vector3(_direction.x, 0, 0), .2f, LayerMask.GetMask("Obstacle")))
            {
