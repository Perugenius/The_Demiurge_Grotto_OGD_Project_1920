...
namespace Mechanics.Enemies
{
    public class Slime : Movable
    {
        ...
        protected override void FixedUpdate()
        {
            ...
            if (!Physics2D.OverlapPoint(Tr.position + new Vector3(_direction.x * 2f, -1, 0), LayerMask.GetMask("Obstacle")) || Physics2D.OverlapPoint(Tr.position + new Vector3(_direction.x, 0, 0), LayerMask.GetMask("Obstacle")))
            {
